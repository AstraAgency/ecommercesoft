          ...
          <div className='w-[500px] p-[40px] flex flex-col gap-4 '>
            ...
            <form action='' className='flex flex-col gap-8	'>
              <div className='flex w-full flex-wrap md:flex-nowrap gap-4'>
                <Input type='nombre' label='Nombre' placeholder='Enter your email' />
                <Input type='apellido' label='Apellido' placeholder='Enter your email' />
              </div>
              <Input type='email' label='Email' placeholder='Enter your email' />
              <Input type='password' label='Password' placeholder='Enter your password' />
              <Button className='bg-violet-500	 text-white'>Registrar cuenta</Button>
            </form>
          </div>
        </div>
      </div>
